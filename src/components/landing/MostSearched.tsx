  ...
  return (
    <section className="py-16 bg-slate-50/80">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="mb-8 text-xl font-bold text-slate-600">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 pb-4">
          {searchedCars.map((car) => (
            <Card
              key={car.id}
              className="group relative overflow-hidden rounded-xl border-border/60 shadow-sm hover:shadow-md py-4 px-4 gap-0 bg-white flex flex-col items-start justify-between min-h-[200px] sm:min-h-[220px]"
            >
